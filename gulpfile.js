...
function moduleTasks(moduleNames) {
    ...
    gulp.task("watch", function() {
        let moduleScript = gulp.watch(
            scripts.watch, { debounceDelay: 2000 },
            gulp.series("js")
        );
...
gulp.task("combineJavaScriptVendor", function() {
    return gulp
        .src([
            "!./views/assets/javascripts/vendors/jquery.min.js",
            "./views/assets/javascripts/vendors/*.js",
        ])
        .pipe(concat("vendors.js"))
        .pipe(gulp.dest("./views/assets/javascripts"));
});

gulp.task("compressCSSVendor", function() {
    return gulp
        .src("./views/assets/stylesheets/vendors/*.css")
        .pipe(concat("vendors.css"))
        .pipe(gulp.dest("./views/assets/stylesheets"));
});

gulp.task("combineDatetimePicker", function() {
    return gulp
        .src([
            "./views/assets/javascripts/qor/qor-config.js",
            "./views/assets/javascripts/qor/qor-material.js",
            "./views/assets/javascripts/qor/qor-modal.js",
            "./views/assets/javascripts/qor/datepicker.js",
            "./views/assets/javascripts/qor/qor-datepicker.js",
            "./views/assets/javascripts/qor/qor-timepicker.js",
        ])
        .pipe(plumber())
        .pipe(
            eslint({
